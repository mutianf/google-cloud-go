...
func TestAcceleratorServer_ReadSecret(t *testing.T) {
...
func TestAcceleratorServer_ReadSecretEOFBeforeNewline(t *testing.T) {
...
func TestAcceleratorServer_ReadSecretEmpty(t *testing.T) {
